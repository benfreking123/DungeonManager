...
func _ready() -> void:
	...
	tween.tween_property(self, "_t", 1.0, maxf(0.05, duration_s)).set_trans(Tween.TRANS_SINE).set_ease(Tween.EASE_OUT)
...
func _draw() -> void:
	...
	# Inner soft fill
	draw_circle(Vector2.ZERO, r * 0.35, Color(c.r, c.g, c.b, a * 0.25))
